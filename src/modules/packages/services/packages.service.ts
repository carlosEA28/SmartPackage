...
import type { UsersRepository } from 'src/modules/users/repository/interfaces/UsersRepository';
import { ResidentsService } from 'src/modules/residents/services/residents.service';
